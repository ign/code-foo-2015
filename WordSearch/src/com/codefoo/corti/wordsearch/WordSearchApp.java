package com.codefoo.corti.wordsearch;
...
public class WordSearchApp {
	...
	{
		gridBlock ="O B M K A T A M A R I O C C S F T P H S"
		...
		wordList = "BLINKY SHINRA RAPTURE ANIMUS FIREFLY WALKERS "
				 + "TARDIS EPONA CREEPER AVENGER PATRONUS WESTEROS "
				 + "IFRIT ARKHAM VAULT CLAPTRAP NORMANDY REAVER "
				 + "HEISENBERG STARK MORDOR BIRDMAN TITAN OCULUS "
				 + "GOOMBA KATAMARI";
	}
}
